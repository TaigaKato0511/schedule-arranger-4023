...
const GITHUB_CLIENT_ID = process.env.GITHUB_CLIENT_ID || 'd1fcfb8041f6f03c8d5a';
const GITHUB_CLIENT_SECRET = process.env.GITHUB_CLIENT_SECRET || 'a62adedcc3eea4082c5afd10d4139f1fa797735f';
